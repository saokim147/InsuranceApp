...
namespace InsuranceWebApp.Repository
{
    public interface IHospitalRepository
    {
        ...
        Task UpdateAsync();
        //Task BulkUpdateLocationAsync(List<MapApiResponseDTO> locations);
        Task DeleteAsync(int id);
        Task<List<FileResponseDTO>> GetFileResponseDTOAsync(bool isBlackList, string lang,string cityName);
